document.addEventListener('DOMContentLoaded', function() {
  ...
  if(country != null) {
    ...
    countryTitle = document.body.appendChild(document.createElement('h2'))
    countryTitle.innerHTML = countryDictionary[country]

    originList = document.body.appendChild(document.createElement('div'))
    originList.classList.add('country_list')
    originList.innerHTML = "Filter the population by place of birth: "

    countryPacks.forEach(function(countryPack) {
      var a = document.createElement('a');
      var linkText = document.createTextNode(countryPack[0] + " ")
      a.appendChild(linkText)
      a.href = "/population?country=" + country + "&from=" + countryPack[1]
      a.title = countryPack[0]
      originList.appendChild(a)
    })
